...
"[project]/components/SignupPage.tsx [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function SignupPage() {
    ...
    const [showCPassword, setShowCPassword] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useState"])(false);
    const onSubmit = async (data)=>{
        setError("");
        try {
            const { confirm_password, ...signupData } = data;
            await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$auth$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["signup"])(signupData);
            router.push("/login");
        } catch (err) {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__e22d8e3b._.js.map