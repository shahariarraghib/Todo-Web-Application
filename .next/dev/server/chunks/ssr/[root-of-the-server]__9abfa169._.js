...
function LoginPage() {
    ...
    const onSubmit = async (data)=>{
        try {
            const response = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$auth$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["login"])({
                email: data.email,
                password: data.password
            });
            if (auth && response.access) {
                ...
                (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$apiHook$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["setAuthToken"])(token);
                try {
                    const userData = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$auth$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["getProfile"])();
                    const user = {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__9abfa169._.js.map