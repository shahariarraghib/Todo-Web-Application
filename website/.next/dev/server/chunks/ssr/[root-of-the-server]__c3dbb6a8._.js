...
const signup = async (data)=>{
    const res = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$apiHook$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].post("/auth/signup", data);
    return res.data;
};
const login = async (data)=>{
    const res = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$apiHook$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].post("/auth/login", data);
    return res.data;
};
const getProfile = async ()=>{
    const res = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$apiHook$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].get("/me");
    return res.data;
};
const fetchTodos = async ()=>{
    const res = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$apiHook$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].get("/todos");
    return res.data;
};
const createTodo = async (payload)=>{
    const res = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$apiHook$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].post("/todos", payload);
    return res.data;
};
const updateTodo = async (id, payload)=>{
    const res = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$apiHook$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].put(`/todos/${id}`, payload);
    return res.data;
};
const deleteTodo = async (id)=>{
    const res = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$apiHook$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].delete(`/todos/${id}`);
    return res.data;
};
const reorderTodos = async (orderedIds)=>{
    const res = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$apiHook$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].post("/todos/reorder", {
        orderedIds
    });
    return res.data;
};
...
function TodoList() {
    ...
    const handleDragEnd = async (event)=>{
        ...
        if (active.id !== over?.id) {
            ...
            try {
                await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$auth$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["reorderTodos"])(newTodos.map((t)=>t.id));
            } catch (err) {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__c3dbb6a8._.js.map