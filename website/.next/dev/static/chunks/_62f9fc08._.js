                        ...
                        children: [
                            ...
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("nav", {
                                ...
                                children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("ul", {
                                    className: "space-y-2",
                                    children: Men.map((item)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("li", {
        ...
        "DashboardPage.useEffect": ()=>{
            if (auth?.token) {
                (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$auth$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["fetchTodos"])().then({
                    "DashboardPage.useEffect": (todos)=>{
                        const todosArray = Array.isArray(todos) ? todos : todos.results || [];
                        setStats({
                            total: todosArray.length,
                            completed: todosArray.filter({
                                "DashboardPage.useEffect": (t)=>t.is_completed
                            }["DashboardPage.useEffect"]).length,
                            pending: todosArray.filter({
                                "DashboardPage.useEffect": (t)=>!t.is_completed
                            }["DashboardPage.useEffect"]).length,
                            extreme: todosArray.filter({
                                "DashboardPage.useEffect": (t)=>t.priority === "extreme"
                            }["DashboardPage.useEffect"]).length,
                            moderate: todosArray.filter({
                                "DashboardPage.useEffect": (t)=>t.priority === "moderate"
                            }["DashboardPage.useEffect"]).length,
                            low: todosArray.filter({
                                "DashboardPage.useEffect": (t)=>t.priority === "low"
                            }["DashboardPage.useEffect"]).length
                        });
                    }
...
_s(DashboardPage, "vSgeQg7M7mPvbpWkh2GnTm+EXhY=", false, function() {
    return [
        __TURBOPACK__imported__module__$5b$project$5d2f$components$2f$AuthProvider$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useAuth"]
    ];
});
...
//# sourceMappingURL=_62f9fc08._.js.map