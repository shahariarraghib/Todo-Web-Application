...
export default function DashboardPage() {
      ...
      fetchTodos()
        .then((todos) => {
          ...
          setStats({
            ...
            extreme: todosArray.filter((t: any) => t.priority === "extreme")
              .length,
            moderate: todosArray.filter((t: any) => t.priority === "moderate")
              .length,
  ...
  return (
    <div className="bg-white mx-10 pt-2 p-8 rounded-md">
      <h1 className="text-2xl md:text-3xl font-bold  mb-4 md:mb-6 lg:mb-8 pb-3 md:pb-4 ">
        Dashboard
        <div className="border-b-2 border-[#5272FF] w-[100px] mb-6"></div>
      </h1>
